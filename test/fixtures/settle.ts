...
//
// It knew both worlds and picked by the flag while the conversion ran; since
// 8.5 there is one. A test that wants a steading says so and stops caring
...
import { canFound, foundSettlement, stopReport } from '../../src/sim/site';
...
export interface SettleOptions {
  /**
   * How far from the landing to look, in stretches of coast.
   *
   ...
   * is "the first stretch that will have them, which is a different and much
